...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (manger) {
        return this.http.post(baseUrl + "/login", manger);
    };
    AuthService.prototype.register = function (manger) {
        return this.http.post(baseUrl + "/register", manger);
    };
...
module.exports = "<form>\n  <div class=\"form-group\">\n    <label for=\"username\">Username:</label>\n    <input type=\"text\" name=\"username\" class=\"form-control\" [(ngModel)]=\"manger.username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password:</label>\n    <input type=\"password\" name=\"password\" class=\"form-control\" [(ngModel)]=\"manger.password\">\n  </div>\n</form>\n<div style=\"text-align:right\">\n  <button type=\"button\" class=\"btn btn-link\" routerLink=\"/register\">\n    Register</button>\n  <button type=\"button\" class=\"btn btn-primary\" (click)=\"login()\">\n    Login</button>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authServie, router) {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authServie.login(this.manger)
            ...
            _this.authServie.saveToken(token);
            _this.router.navigate(['/']);
        }, function (err) {
            if (err.status == 401) {
                _this.manger = { username: '', password: '' };
...
module.exports = "<form>\n    <div class=\"form-group\">\n      <label for=\"username\">Username:</label>\n      <input type=\"text\" name=\"username\" class=\"form-control\" [(ngModel)]=\"manger.username\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"password\">Password:</label>\n      <input type=\"password\" name=\"password\" class=\"form-control\" [(ngModel)]=\"manger.password\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"password_confirm\">Confirm Password:</label>\n        <input type=\"password\" name=\"password_confirm\" class=\"form-control\" [(ngModel)]=\"password_confirm\">\n      </div>\n  </form>\n  <div style=\"text-align:center\">\n    <button type=\"button\" class=\"btn btn-success\" (click)=\"register()\">\n      Register</button>\n  </div>"
...
module.exports = "<form *ngIf=\"user\">\n  <div class=\"form-group\">\n    <label for=\"name\">Name:</label>\n    <input type=\"text\" name=\"name\" class=\"form-control\" [(ngModel)]=\"user.name\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"gender\">Gender</label>\n    <select class=\"form-control\" name=\"gender\" value=\"user.gender\" [(ngModel)]=\"user.gender\">\n      <option value=\"male\">Male</option>\n      <option value=\"female\">Female</option>\n    \n    </select>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"gender\">Birth Date:</label>\n    <input type=\"date\" class=\"form-control\" name=\"birthdate\" (input)=\"onDateChange($event.target.value)\" value=\"{{user.birthdate| date:'yyyy-MM-dd'}}\"  min=\"1900-01-01\" max=\"2100-12-31\"/>\n  </div>\n</form>\n\n\n<div *ngIf=\"isEditing\" style=\"text-align:center\">\n    <button type=\"button\" class=\"btn btn-outline-primary\" (click)=\"updateUser()\">Update</button>\n    <button type=\"button\" class=\"btn btn-outline-danger\"(click)=\"deleteUser()\">Delete</button>    \n</div>\n<div *ngIf=\"!isEditing\" style=\"text-align:center\">\n    <button type=\"button\" class=\"btn btn-outline-primary\" (click)=\"addUser()\">Add</button>\n</div>\n"
...
var UserEditComponent = /** @class */ (function () {
    ...
    UserEditComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            if (params['id']) {
                ...
                _this.user = { name: '', gender: '', birthdate: new Date("yyyy-mm-dd") };
            }
        });
    };
    ...
    UserEditComponent.prototype.addUser = function () {
        var _this = this;
    ...
    UserEditComponent.prototype.onDateChange = function (date) {
        this.user.birthdate = new Date(date);
    };
    UserEditComponent.prototype.returnToList = function () {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(userUrl + "/list", this.httpOptions());
    };
    UserService.prototype.getById = function (id) {
        return this.http.get(userUrl + "/" + id, this.httpOptions());
    };
    UserService.prototype.add = function (user) {
        return this.http.post(userUrl, user, this.httpOptions());
    };
    UserService.prototype.update = function (id, user) {
        return this.http.put(userUrl + "/" + id, user, this.httpOptions());
    };
    UserService.prototype.delete = function (id) {
        return this.http.delete(userUrl + "/" + id, this.httpOptions());
    };
    UserService.prototype.getToken = function () {
        return JSON.parse(localStorage.getItem('token'));
    };
    UserService.prototype.httpOptions = function () {
        return { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Authorization': "bearer " + this.getToken().token }) };
    };
...
module.exports = "<div style=\"text-align:center\">\n  <button type=\"button\" class=\"btn btn-outline-primary\" routerLink=\"/user-edit/\">\n    Add</button>\n</div>\n\n<div class=\"list-group\" *ngFor=\"let user of users\">\n  <a href=\"#\" routerLink=\"/user-edit/{{ user._id }}\" class=\"list-group-item list-group-item-action flex-column align-items-start\">\n    <div class=\"d-flex w-100 justify-content-between\">\n      <h5 class=\"mb-1\">{{ user.name }}</h5>\n    </div>\n    <p class=\"mb-1\">{{ user.gender }} </p>\n    <p class=\"mb-1\">{{ user.birthdate | date:'longDate' }} </p>\n  </a>\n\n</div>"
...
module.exports = __webpack_require__(/*! D:\Project\MEAN\Aimazing_HW\angular\src\main.ts */"./src/main.ts");
